...
class Staff extends CI_Controller 
{
    ...
    public function praEdit(){
        ...
        // jika login maka akan meng eksekusi printah add ke database
            ...
            $id_staff= htmlspecialchars($this->input->post('staffid',true));
            $dataedit = $this->Basemodel->staffPraedit($id_staff)->row();
            ...
            <div class="form-group">
                  ...
                  <input type="hidden" name="id_staff" value="'.$dataedit->id_staff.'">
    ...
    public function update(){
      // password_hash($this->input->post('pass'), PASSWORD_DEFAULT)
        ...
        // jika login maka akan meng eksekusi printah add ke database
            ...
            $id_staff = htmlspecialchars($this->input->post('id_staff',true));

            $this->Basemodel->updateStaff($form,$id_staff);
    ...
    public function hapus($a){
      if ($this->session->userdata('login') != 'zpmlogin') {
        ...
        $id_staff = $a;
        $this->Basemodel->hapusStaff($id_staff);
